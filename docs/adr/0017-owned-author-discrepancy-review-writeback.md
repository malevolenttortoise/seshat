...
- A v3.x follow-up captures **MAM as an enqueue source** when prioritized; threading point is `app/orchestrator/auto_train.py:train_authors_from_blob` (grab completion), payload shape is unchanged from #1.
