...
const onAction=async(act,id)=>{const scrollY=window.scrollY;if(act==="unhide")await api.post(`/discovery/books/${id}/unhide`);await load();setTimeout(()=>window.scrollTo(0,scrollY),100)};
